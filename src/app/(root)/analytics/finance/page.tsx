    ...
    <div className="space-y-8">
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-3 tracking-tight">Financial Analytics</h1>
            <p className="text-slate-600 text-lg">Analyze financial performance and cash flow.</p>
          </div>
      ...
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-6">
        <h3 className="text-xl font-semibold text-slate-900 mb-6 tracking-tight">Financial Overview</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center p-6 rounded-2xl hover:bg-white/50 transition-colors border border-slate-200/50">
            <p className="text-3xl font-bold text-red-600">$12,340</p>
            <p className="text-slate-600 font-medium">Total Expenses</p>
          </div>
          <div className="text-center p-6 rounded-2xl hover:bg-white/50 transition-colors border border-slate-200/50">
            <p className="text-3xl font-bold text-blue-600">$33,338</p>
            <p className="text-slate-600 font-medium">Net Profit</p>
          </div>
        </div>
      </div>
    </div>
